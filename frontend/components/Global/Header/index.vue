  ...
  <div class="bg-white">
    ...
    <HeadlessTransitionRoot as="template" :show="open">
      ...
      >
        ...
        >
          <div
            class="relative max-w-sm w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto"
          >
                        ...
                        >
                          <div class="relative flex">
                            ...
                            >
                              {{ category.name }}
                              <ChevronDownIcon
                                class="w-4 ml-2 hover:transform transition duration-50 ease-in-out dropdowwn-chevron"
                              />
                            </HeadlessPopoverButton>
                          </div>
